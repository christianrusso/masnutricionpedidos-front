...
export class ListarComponent implements OnInit, AfterViewInit {
  delete!: boolean;
  constructor( private readonly telefonoService: TelefonoService, private readonly router: Router, private dialog: MatDialog,) {
  ...
  goToEditPage(id: number) {
    this.router.navigateByUrl(`/telefonos/modificar/${id}`);
  }
