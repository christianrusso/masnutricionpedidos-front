...
export class ListarComponent implements OnInit, AfterViewInit {
  delete!: boolean;
  constructor( private readonly clienteService: ClienteService, private readonly router: Router, private dialog: MatDialog,) {
  ...
  goToEditPage(idTipoCliente: number) {
    this.router.navigateByUrl(`/cliente/modificar/${idTipoCliente}`);
  }
