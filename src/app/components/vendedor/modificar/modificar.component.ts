...
import { VendedorEdit } from 'src/app/models/vendedor-edit';
...
export class ModificarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.vendedorService.getVendedor(this.id).subscribe((response: any) => {
  ...
  onEdit() {
    const vendedor = new VendedorEdit({
    ...
    this.vendedorService.editVendedor(vendedor, this.id).subscribe((response) => {
