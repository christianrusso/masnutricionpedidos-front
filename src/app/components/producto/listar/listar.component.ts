...
export class ListarComponent implements OnInit, AfterViewInit {
  delete!: boolean;
  constructor( private readonly productoService: ProductoService, private readonly router: Router, private dialog: MatDialog,) {
  ...
  goToEditPage(id: number) {
    this.router.navigateByUrl(`/productos/modificar/${id}`);
  }
